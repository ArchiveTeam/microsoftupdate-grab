...
LUA_SHA1 = get_hash(os.path.join(CWD, 'microsoftupdate.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            '--content-on-error',
            '--lua-script', 'microsoftupdate.lua',
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/f/f8/Windowsupdate-icon.png" height="50px" title=""/>
        <h2>Microsoft Update <span class="links"><a href="https://www.catalog.update.microsoft.com/">Website</a> &middot; <a href="https://tracker.archiveteam.org/microsoftupdate/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Microsoft Update">Wiki</a></span></h2>
        <p>Archiving Microsoft Update.</p>
    '''
)
